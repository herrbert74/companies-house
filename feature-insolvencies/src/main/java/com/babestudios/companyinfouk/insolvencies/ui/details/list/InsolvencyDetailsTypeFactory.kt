...
class InsolvencyDetailsTypeFactory : InsolvencyDetailsAdapter.InsolvencyDetailsTypeFactory {
	...
	override fun type(insolvencyDetailsDateItem: InsolvencyDetailsDateItem): Int = R.layout.row_two_lines

	override fun type(practitioner: Practitioner): Int = R.layout.row_insolvency_details_practitioner
