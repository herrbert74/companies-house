...
private val favourites = listOf(
	SearchHistoryItem("Acme Painting", "1", 111L),
	SearchHistoryItem("You Limited", "04475590", 111L)
)
...
private val officersResponseYouLimited: OfficersResponse = OfficersResponse(
	...
	items = listOf(
		Officer(
			...
			name = "STEVENSON, Elizabeth Mary",
			officerRole = "Secretary",
			dateOfBirth = YearMonth(year = 0, month = 1),
			occupation = "Director",
			countryOfResidence = "Unknown",
			nationality = "British",
			resignedOn = null,
			fromToString = "From 2002-07-02",
			appointmentsId = "M0nRpSZPlPTwBusql3sNK6Efzr8"
		),
		Officer(
			address = Address(
			...
			links = OfficerLinks(
				officer =
					OfficerRelatedLinks(appointments = "/officers/5SU_9GfEsP_Z_H7rb1fNFmEZvKs/appointments")
			),
			name = "STEVENSON, Benjamin Thomas",
			officerRole = "Director",
			dateOfBirth = YearMonth(year = 1985, month = 7),
		...
		Officer(
			...
			appointedOn = "2002-07-02",
			links = OfficerLinks(
				officer = OfficerRelatedLinks(appointments = "/officers/M0nRpSZPlPTwBusql3sNK6Efzr8/appointments")
			),
			name = "STEVENSON, Elizabeth Mary",
			officerRole = "Director",
			dateOfBirth = YearMonth(year = 1957, month = 3),
			occupation = "Director",
			countryOfResidence = "England",
			nationality = "British",
			resignedOn = null,
		...
		Officer(
			address = Address(
				addressLine1 = "84 Temple Chambers",
				addressLine2 = "Temple Avenue",
				country = "Unknown",
				locality = "London",
				postalCode = "EC4Y 0HP",
				region = ""
			...
			officerRole = "Nominee Secretary",
			dateOfBirth = YearMonth(year = 0, month = 1),
			occupation = "Unknown",
			countryOfResidence = "Unknown",
			nationality = "Unknown",
			resignedOn = "2002-07-02",
			fromToString = "From 2002-07-02 to 2002-07-02",
			appointmentsId = "yijMAlD-g9qcqcbX0w6AFDbcWtQ"
		),
		Officer(
			address = Address(
				addressLine1 = "84 Temple Chambers",
			...
			resignedOn = "2002-07-02",
			fromToString = "From 2002-07-02 to 2002-07-02",
			appointmentsId = "It1fdjIyCDqgLpk3nYKsWymv32U"
		),
		Officer(
			address = Address(
				addressLine1 = "Edmonds Drive",
				addressLine2 = "Ketton",
				country = "England",
				locality = "Stamford",
				postalCode = "PE9 3TH",
			...
			name = "STEVENSON, Benjamin Thomas",
			officerRole = "Director",
			dateOfBirth = YearMonth(year = 1985, month = 6),
			occupation = "Company Director",
			countryOfResidence = "England",
			nationality = "British",
			resignedOn = "2017-09-01",
			fromToString = "From 2012-11-09 to 2017-09-01",
			appointmentsId = "mqkD15s6orcvxGCwF0zIaU7bw1I"
		),
		Officer(
			address = Address(
				addressLine1 = "Huckleberry House",
				addressLine2 = "4a Edmunds Drive",
				country = "",
				locality = "Ketton",
				postalCode = "PE9 3TH",
				region = "Lincolnshire"
			...
			name = "STEVENSON, Leslie Alan",
			officerRole = "Director",
			dateOfBirth = YearMonth(year = 1950, month = 4),
			occupation = "Director",
			countryOfResidence = "Unknown",
			nationality = "British",
			resignedOn = "2012-08-28",
			fromToString = "From 2002-07-02 to 2012-08-28",
			appointmentsId = "w01KCApAVX3NeT_TR6yliDQ44lU"
		)
	)
)

private val appointedToYouLimited =
	AppointedTo(companyName = "YOU LIMITED", companyNumber = "04475590", companyStatus = "active")
...
private val officersAppointmentsYouLimited: AppointmentsResponse = AppointmentsResponse(
	...
	items = listOf(
		Appointment(
			...
			appointedOn = "2002-07-02",
			appointedTo = appointedToYouLimited,
			countryOfResidence = null,
			name = "Elizabeth Mary STEVENSON",
			nationality = "British",
			occupation = "Director",
			officerRole = "Secretary",
			resignedOn = null
